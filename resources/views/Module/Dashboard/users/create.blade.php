...
<div class="container mx-auto">
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('superadmin.users.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <div id="initialPlaceholder" class="w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center">
